...
class HpsModel_frame:
	...
	def initUI(self):
		...
		tk.Label(self.parent, text=M_label).grid(row=4, column=0, sticky=tk.W, padx=5, pady=(10,2))
		self.M = tk.Entry(self.parent, justify=tk.CENTER)
		self.M["width"] = 5
		self.M.grid(row=4,column=0, sticky=tk.W, padx=(115,5), pady=(10,2))
		self.M.delete(0, tk.END)
		self.M.insert(0, "601")

		#FFT SIZE
		N_label = "FFT size (N) (power of two bigger than M):"
		tk.Label(self.parent, text=N_label).grid(row=5, column=0, sticky=tk.W, padx=5, pady=(10,2))
		self.N = tk.Entry(self.parent, justify=tk.CENTER)
		self.N["width"] = 5
		self.N.grid(row=5,column=0, sticky=tk.W, padx=(270,5), pady=(10,2))
		self.N.delete(0, tk.END)
		self.N.insert(0, "1024")

		#THRESHOLD MAGNITUDE
		t_label = "Magnitude threshold (t) (in dB):"
		tk.Label(self.parent, text=t_label).grid(row=6, column=0, sticky=tk.W, padx=5, pady=(10,2))
		self.t = tk.Entry(self.parent, justify=tk.CENTER)
		self.t["width"] = 5
		self.t.grid(row=6, column=0, sticky=tk.W, padx=(205,5), pady=(10,2))
		self.t.delete(0, tk.END)
		self.t.insert(0, "-100")

		#MIN DURATION SINUSOIDAL TRACKS
		minSineDur_label = "Minimum duration of sinusoidal tracks:"
		tk.Label(self.parent, text=minSineDur_label).grid(row=7, column=0, sticky=tk.W, padx=5, pady=(10,2))
		self.minSineDur = tk.Entry(self.parent, justify=tk.CENTER)
		self.minSineDur["width"] = 5
		self.minSineDur.grid(row=7, column=0, sticky=tk.W, padx=(250,5), pady=(10,2))
		self.minSineDur.delete(0, tk.END)
		self.minSineDur.insert(0, "0.1")

		#MAX NUMBER OF HARMONICS
		nH_label = "Maximum number of harmonics:"
		tk.Label(self.parent, text=nH_label).grid(row=8, column=0, sticky=tk.W, padx=5, pady=(10,2))
		self.nH = tk.Entry(self.parent, justify=tk.CENTER)
		self.nH["width"] = 5
		self.nH.grid(row=8, column=0, sticky=tk.W, padx=(215,5), pady=(10,2))
		self.nH.delete(0, tk.END)
		self.nH.insert(0, "100")

		#MIN FUNDAMENTAL FREQUENCY
		minf0_label = "Minimum fundamental frequency:"
		tk.Label(self.parent, text=minf0_label).grid(row=9, column=0, sticky=tk.W, padx=5, pady=(10,2))
		self.minf0 = tk.Entry(self.parent, justify=tk.CENTER)
		self.minf0["width"] = 5
		self.minf0.grid(row=9, column=0, sticky=tk.W, padx=(220,5), pady=(10,2))
		self.minf0.delete(0, tk.END)
		self.minf0.insert(0, "350")

		#MAX FUNDAMENTAL FREQUENCY
		maxf0_label = "Maximum fundamental frequency:"
		tk.Label(self.parent, text=maxf0_label).grid(row=10, column=0, sticky=tk.W, padx=5, pady=(10,2))
		self.maxf0 = tk.Entry(self.parent, justify=tk.CENTER)
		self.maxf0["width"] = 5
		self.maxf0.grid(row=10, column=0, sticky=tk.W, padx=(220,5), pady=(10,2))
		self.maxf0.delete(0, tk.END)
		self.maxf0.insert(0, "700")

		#MAX ERROR ACCEPTED
		f0et_label = "Maximum error in f0 detection algorithm:"
		tk.Label(self.parent, text=f0et_label).grid(row=11, column=0, sticky=tk.W, padx=5, pady=(10,2))
		self.f0et = tk.Entry(self.parent, justify=tk.CENTER)
		self.f0et["width"] = 5
		self.f0et.grid(row=11, column=0, sticky=tk.W, padx=(265,5), pady=(10,2))
		...
		tk.Label(self.parent, text=harmDevSlope_label).grid(row=12, column=0, sticky=tk.W, padx=5, pady=(10,2))
		self.harmDevSlope = tk.Entry(self.parent, justify=tk.CENTER)
		self.harmDevSlope["width"] = 5
		self.harmDevSlope.grid(row=12, column=0, sticky=tk.W, padx=(285,5), pady=(10,2))
		self.harmDevSlope.delete(0, tk.END)
		self.harmDevSlope.insert(0, "0.01")

		#DECIMATION FACTOR
		stocf_label = "Stochastic approximation factor:"
		tk.Label(self.parent, text=stocf_label).grid(row=13, column=0, sticky=tk.W, padx=5, pady=(10,2))
		self.stocf = tk.Entry(self.parent, justify=tk.CENTER)
		self.stocf["width"] = 5
		self.stocf.grid(row=13, column=0, sticky=tk.W, padx=(210,5), pady=(10,2))
		...
		self.compute.grid(row=14, column=0, padx=5, pady=(10,2), sticky=tk.W)

		#BUTTON TO PLAY SINE OUTPUT
		output_label = "Sinusoidal:"
		tk.Label(self.parent, text=output_label).grid(row=15, column=0, sticky=tk.W, padx=5, pady=(10,0))
		self.output = tk.Button(self.parent, text=">", command=lambda:UF.wavplay('output_sounds/' + os.path.basename(self.filelocation.get())[:-4] + '_hpsModel_sines.wav'), bg="gray30", fg="white")
		self.output.grid(row=15, column=0, padx=(80,5), pady=(10,0), sticky=tk.W)

		#BUTTON TO PLAY STOCHASTIC OUTPUT
		output_label = "Stochastic:"
		tk.Label(self.parent, text=output_label).grid(row=16, column=0, sticky=tk.W, padx=5, pady=(5,0))
		self.output = tk.Button(self.parent, text=">", command=lambda:UF.wavplay('output_sounds/' + os.path.basename(self.filelocation.get())[:-4] + '_hpsModel_stochastic.wav'), bg="gray30", fg="white")
		self.output.grid(row=16, column=0, padx=(80,5), pady=(5,0), sticky=tk.W)

		#BUTTON TO PLAY OUTPUT
		output_label = "Output:"
		tk.Label(self.parent, text=output_label).grid(row=17, column=0, sticky=tk.W, padx=5, pady=(5,15))
		self.output = tk.Button(self.parent, text=">", command=lambda:UF.wavplay('output_sounds/' + os.path.basename(self.filelocation.get())[:-4] + '_hpsModel.wav'), bg="gray30", fg="white")
		self.output.grid(row=17, column=0, padx=(80,5), pady=(5,15), sticky=tk.W)
