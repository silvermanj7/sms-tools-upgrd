...
class SineModel_frame:
	...
	def initUI(self):
		...
		output_label = "Output:"
		tk.Label(self.parent, text=output_label).grid(row=11, column=0, sticky=tk.W, padx=5, pady=(10,15))
		...
		self.output.grid(row=11, column=0, padx=(60,5), pady=(10,15), sticky=tk.W)
